package distance.learning.server.util;
 ...
 */
public class Util {
    public static Controller showWindow(String resource, String title, ServerMainApp serverMainApp) {
        BorderPane pane;
        try {
            ...
            controller.setMainApp(serverMainApp);
