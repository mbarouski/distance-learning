...
import distance.learning.instrument.*;
 ...
 */
public class ServerMainWindowController extends Controller{
    ...
    public Figure createFigure(){
        ...
        switch(currentInstrument){
            ...
            case "Text":
                currentInstrument = "";
                TextInputWindowController textInputWindowController = (TextInputWindowController) Util.showWindow("TextInputWindow.fxml", "Adding text", getMainApp());
    ...
    private void onMicrophoneButtonClicked(){
        ...
        if(getMainApp().microphoneState)
            btnMicrophone.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/microphone.png"))));
        else
            btnMicrophone.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/non-microphone.png"))));
    }

    public void initialize(){
        btnRectangle.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/rectangle.png"))));
        btnEllipse.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/ellipse.png"))));
        btnPencil.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/pencil.png"))));
        btnPolyline.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/polyline.png"))));
        btnClear.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/clear.png"))));
        btnMicrophone.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/non-microphone.png"))));
        btnText.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../resources/icon/text.png"))));
        onClearButtonClick();
        tableColumn.setCellValueFactory(new PropertyValueFactory<Figure, String>("description"));
    ...
    public void beginRecord(){
        if(btnStartTranslation.getText().equals("Start translation")) {
                    ...
                    try {
                        while (!figureServerSocketThread.isInterrupted()) {
                            ...
                            if (messageServer.connected) {
                                serverMainApp.messageServerList.add(messageServer);
                            }
                        }
                ...
                public void run() {
                    try {
                        while (!stopFlag) {
                            ...
                            if (figureServer != null)
                                serverMainApp.figureServerList.add(figureServer);
                        }
            ...
            try {
                ...
                btnStartTranslation.setText("Start translation");
                getMainApp().rootController.setMenuFileActive(true);
                Util.showErrorMessage("record" + exc.getMessage());
            }
        }
    ...
    public void sendFigureToAll(Figure f){
